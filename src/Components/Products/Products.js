		...
		<main className={classes.products}>
			<section>
				<article className={classes.pageInfo}>
					...
					<p>
						Während Sie auf unserer Seite sind, sollten Sie unbedingt einen Blick auf unseren Bestand
						werfen. Unser/e Vitamin- and Nahrungsergänzungs-Geschäft ist stolz darauf, eine beispiellose
