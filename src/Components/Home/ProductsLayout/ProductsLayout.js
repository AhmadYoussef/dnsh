    ...
    return(
        <section className={classes.productsLayout}>
            ...
            <article className={classes.products}>
                <figure>
                        <img src={require('../../_assets/imgs/animalhealth.jpg')} alt=""/>
                        <figcaption>
                            <h3>Animal Health</h3>
                            <div className={classes.bottomProducts}>
                                <NavLink className={classes.ServiceBtn} to="/products/animalHealth">Read More</NavLink>
                            </div>
                        </figcaption>
                </figure>
                <figure>
                    ...
                    <figcaption>
                        ...
                        <div className={classes.bottomProducts}>
                            <NavLink className={classes.ServiceBtn} to="/products/feedAdditives">Read More</NavLink>
                        </div>
                    </figcaption>
                </figure>
                <figure>
                    ...
                    <figcaption>
                        ...
                        <div className={classes.bottomProducts}>
                            <NavLink className={classes.ServiceBtn} to="/products/premixes">Read More</NavLink>
                        </div>
                    </figcaption>
                </figure>
            </article>
